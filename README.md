...
<!-- ![](https://badge.mediaplus.ma/darkgray/yhammani) -->

<!--
**youssefhammani/youssefhammani** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
![Cover](https://raw.githubusercontent.com/youssefhammani/youssefhammani/main/assets/header.svg)


$${\color{red}Bonjour, \space \color{lightblue}je \space suis \space \color{orange}Youssef \space Hammani 👋}$$
...
class Me extends Person {
  constructor() {
    super();
    this.name = "Youssef Hammani";
    this.profession = "Développeur Frontend";
    this.location = "MAROC - SALE";
    this.email = "youssefhammani04@gmail.com";
    this.phone = "+212 669991211";
  }
}
```
